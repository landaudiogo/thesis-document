...
\begin{figure}[H] 
    \centering
    \subfigure[]{
        \includegraphics[width=0.3\textwidth]{images/controller/pareto_front/5.png}
    }
    \subfigure[]{
        \includegraphics[width=0.3\textwidth]{images/controller/pareto_front/10.png}
    }
    \subfigure[]{
        \includegraphics[width=0.3\textwidth]{images/controller/pareto_front/15.png}
    }
    \subfigure[]{
        \includegraphics[width=0.3\textwidth]{images/controller/pareto_front/20.png}
    }
    \subfigure[]{
        \includegraphics[width=0.3\textwidth]{images/controller/pareto_front/25.png}
    }
    \caption{
        (a) Pareto front for $\delta = 5$ (b) Pareto front for $\delta = 10$ (c)
        Pareto front for $\delta = 15$ (d) Pareto front for $\delta = 20$ (e)
        Pareto front for $\delta = 25$
    } 
